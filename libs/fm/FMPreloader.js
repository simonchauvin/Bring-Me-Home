...
function fmPreloader(firstState) {
    ...
    that.init = function () {
        ...
        fmAssetManager.addAsset("fmPauseIcon", fmParameters.IMAGE, fmParameters.libraryDirectory + "/fm/assets/gfx/fm_pause.png");
        fmAssetManager.addAsset("fmMuteIcon", fmParameters.IMAGE, fmParameters.libraryDirectory + "/fm/assets/gfx/fm_mute.png");
        fmAssetManager.addAsset("fmSoundOnIcon", fmParameters.IMAGE, fmParameters.libraryDirectory + "/fm/assets/gfx/fm_sound_on.png");
        fmAssetManager.addAsset("fmLogo", fmParameters.IMAGE, fmParameters.libraryDirectory + "/fm/assets/gfx/fm_logo.png");
        fmAssetManager.loadAssets();

        //Create the loading text
        loadingIndicator = fmGameObject(99);
        var spatial = fmSpatialComponent(loadingIndicator, fmParameters.screenWidth / 2, fmParameters.screenHeight / 2);
        var textRenderer = fmTextRendererComponent(loadingIndicator, 100);
